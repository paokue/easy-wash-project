...
import { Settings, Globe, Bell, Shield, Mail, Database, Palette, Zap, Save, RefreshCw } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Configure and manage system-wide settings</p>
        </div>
        ...
        <TabsContent value="general" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Basic information about your Easywash platform</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="platform-name">Platform Name</Label>
                  <Input id="platform-name" defaultValue="Easywash" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="platform-url">Platform URL</Label>
                  <Input id="platform-url" defaultValue="https://easywash.com" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  defaultValue="Modern laundry service management platform"
                  rows={3}
                />
              </div>
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="support-email" type="email" defaultValue="support@easywash.com" />
                </div>
                <div className="space-y-2">
        ...
        <TabsContent value="notifications" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Shop Notifications</Label>
                  <p className="text-sm text-muted-foreground">Alert shops about new orders and updates</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Receive alerts for system issues and updates</p>
                </div>
                <Switch defaultChecked />
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="smtp-host" defaultValue="smtp.easywash.com" />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="smtp-username" defaultValue="noreply@easywash.com" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="from-email" type="email" defaultValue="noreply@easywash.com" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="from-name">From Name</Label>
                <Input id="from-name" defaultValue="Easywash Team" />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input id="primary-color" type="color" defaultValue="#0891b2" className="w-20" />
